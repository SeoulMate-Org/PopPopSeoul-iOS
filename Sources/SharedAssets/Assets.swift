...
public enum Assets {
  ...
  public enum Images {
    ...
    public static let onboardingEng1 = ImageAsset(name: "onboarding_eng_1")
    public static let onboardingEng2 = ImageAsset(name: "onboarding_eng_2")
    public static let onboardingEng3 = ImageAsset(name: "onboarding_eng_3")
    public static let onboardingEng4 = ImageAsset(name: "onboarding_eng_4")
    public static let onboardingKor1 = ImageAsset(name: "onboarding_kor_1")
    public static let onboardingKor2 = ImageAsset(name: "onboarding_kor_2")
    public static let onboardingKor3 = ImageAsset(name: "onboarding_kor_3")
    public static let onboardingKor4 = ImageAsset(name: "onboarding_kor_4")
    public static let onboardingLine = ImageAsset(name: "onboarding_line")
    public static let onboardingNumber1 = ImageAsset(name: "onboarding_number_1")
    public static let onboardingNumber2 = ImageAsset(name: "onboarding_number_2")
    public static let onboardingNumber3 = ImageAsset(name: "onboarding_number_3")
